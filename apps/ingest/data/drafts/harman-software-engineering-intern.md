...
| **Company** | Harman |
| **Role** | Software Engineering Intern |
| **Qualification** | B.E/B-Tech, M.E/M-Tech, BCA/MCA |
...
- Android
- Embedded Systems
- Good knowledge of C, C++, Java, Android, and Embedded Systems
...
- Learn and develop software using C, C++, Java, or other selected programming languages on the Android platform
- Gain understanding of Android fundamentals and embedded systems concepts
